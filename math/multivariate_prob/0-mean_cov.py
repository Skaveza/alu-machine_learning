...
def mean_cov(X):
    ...
    tuple: A tuple containing:
        - mean (numpy.ndarray): An array of shape (1, d) containing the mean of the dataset.
        - cov (numpy.ndarray): An array of shape (d, d) containing the covariance matrix of the dataset.
